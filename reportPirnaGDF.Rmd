...
x.annotate <-
  if (meltMUTdata[AF.Tipo == "AF > 0" & `Mutação.Tipo` == "INDEL", .N]$N == 0) {
     c(0.64, 0.82, 1, 1.18, 1.36)
  } else {
    c(0.64, 0.82, 1, 1.18, 1.36, 1.64, 1.82, 2, 2.18, 2.36)
  }
...
for (nameMut in c("INDEL", "SNP")) {
  ...
  if (nameMut == "SNP") {
    text(
      x      = c(355 + 10, 170 - 5), cex = c(1.1, 0.8), 
